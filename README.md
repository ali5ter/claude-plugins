...
| [tui-ux-tester](https://github.com/ali5ter/claude-tui-ux-skill) | 1.1.1 | Expert UX evaluator for terminal user interfaces (TUIs). Rates usability across 11 criteria from real captured or user-provided recordings, grounded in named design canons (clig.dev, Nielsen heuristics, Charm, WCAG), with parallel evaluation agents, persistent memory, and a research mode that grows its TUI pattern library. |
